      ...
      <section className="relative min-h-screen flex flex-col overflow-hidden mt-[70px]">
        ...
        <div className="relative z-20 container mx-auto px-4 pt-8 pb-8 flex flex-col min-h-[calc(100vh-70px)]">
          ...
          <div className="flex-1 flex flex-col items-center justify-start text-center max-w-4xl mx-auto relative">
            ...
            <h1 className="text-[22px] sm:text-[28px] md:text-[42px] lg:text-[48px] font-black text-white mb-20 uppercase leading-tight relative z-10 px-2" style={{fontFamily: 'Oswald, Arial, sans-serif', fontWeight: 900, textShadow: '0px 3px 12px rgba(0,0,0,0.9)', letterSpacing: '0.02em'}}>
              ЗАПИШИТЕ РЕБЕНКА НА ПЛАВАНИЕ И ПОЛУЧИТЕ{' '}
              <span className="inline-block bg-primary text-white font-black px-2 py-1 rounded-lg text-[20px] sm:text-[26px] md:text-[42px] lg:text-[48px]">-60%</span> НА ПЕРВОЕ ЗАНЯТИЕ
            </h1>
