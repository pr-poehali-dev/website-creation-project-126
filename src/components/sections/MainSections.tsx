    ...
    <>
      <section className="relative min-h-screen flex flex-col overflow-hidden mt-[70px]">
        ...
        <div 
          ...
          style={{
            backgroundImage: 'url(https://cdn.poehali.dev/files/291195c1-6f9d-48ef-9438-9a012aea231d.JPG)',
        ...
        <div className="relative z-20 container mx-auto px-4 pt-8 pb-8 flex flex-col min-h-[calc(100vh-70px)]">
          ...
          <div className="text-center mb-16 relative">
            ...
            <img 
              ...
              alt="ПЛЮХбург"
              className="absolute -left-4 sm:left-15 md:right-8 lg:right-12 md:left-auto top-0 w-16 h-16 sm:w-24 sm:h-24 md:w-36 md:h-36 lg:w-40 lg:h-40 object-contain"
            />
          </div>
